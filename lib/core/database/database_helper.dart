...
class DatabaseHelper {
  ...
  Future<void> _insertDefaultReadingPlans(Database db) async {
    ...
    // This includes:
    // - 4 curated thematic plans (30 Days of Grace, Finding Peace in Anxiety, Advent Journey, Identity in Christ)
    // - 3 book-based plans (Gospel of John, Proverbs, Psalms for Prayer)
    // - 6 generator-based plans (New Testament, Wisdom Literature, 4 Gospels, One Year Bible, Paul's Letters, Pentateuch)
    // Total: 13 plans × 2 languages = 26 localized reading plans
  }
