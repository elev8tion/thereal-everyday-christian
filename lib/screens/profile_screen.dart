        ...
        children: [
              ...
              const TextSpan(
                children: [
                  ...
                  TextSpan(text: ': When you use the Premium AI pastoral guidance feature (150 messages/month, approximately \$35.99/year subscription, pricing may vary by region and currency), your chat messages are sent to Google\'s Gemini 2.0 Flash API to generate biblically-grounded responses.'),
                ],
              ),
              const TextSpan(text: '\n'),
              const TextSpan(text: '\n'),
              ...
              const TextSpan(
                children: [
                  ...
                  TextSpan(text: ' Our only revenue comes from optional Premium subscriptions (~\$35.99/year, pricing may vary by region and currency).'),
                ],
              ),
              const TextSpan(text: '\n'),
              const TextSpan(text: '\n'),
              ...
              const TextSpan(text: '\n'),
              const TextSpan(text: '- Confirm \$35.99/year pricing (pricing may vary by region and currency)\n'),
      ...
      TextSpan(
        ...
        children: [
              ...
              const TextSpan(
                children: [
                  TextSpan(
                    text: 'Premium Features (approximately \$35.99/year, pricing may vary by region and currency):',
                    style: TextStyle(fontWeight: FontWeight.w600),
                  ),
                ],
              ),
              ...
              const TextSpan(text: '\n'),
              const TextSpan(text: '  - Price: \$35.99 USD per year (pricing may vary by region and currency)\n'),
